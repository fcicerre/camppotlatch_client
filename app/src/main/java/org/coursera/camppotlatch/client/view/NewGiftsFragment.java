...
public class NewGiftsFragment extends AbstractGiftsFragment {
    ...
    protected List<Gift> loadGifts(String mSearchText, int offset, int limit) {
        ...
        if (svc != null) {
            ...
            Collection<Gift> retrievedGifts = svc.findAll(minDateStr, maxDateStr, mSearchText,
                    AppContext.getUser().getDisableInappropriate(), offset, limit);
