...
public class LikeMark {
    ...
    public LikeMark(String giftId, String userLogin, Date createTime) {
        this.giftId = giftId;
    ...
    /**
     * Two like marks will generate the same hashcode if they have exactly the same
    ...
    /**
     * Two like marks are considered equal if they have exactly the same values for
