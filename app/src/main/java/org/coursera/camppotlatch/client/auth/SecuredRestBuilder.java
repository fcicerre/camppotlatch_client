 ...
 ** 
 */
package org.coursera.camppotlatch.client.auth;
...
import org.coursera.camppotlatch.client.json.DateJsonSerializer;
...
public class SecuredRestBuilder extends RestAdapter.Builder {
	...
	public RestAdapter build() {
        ...
        // Set custom adapter to serialize java.util.Date type
