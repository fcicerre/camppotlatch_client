...
public interface GiftServiceApi {
    ...
    public static final String FIND_GIFT_BY_CREATOR_LOGIN_PATH =
            GIFT_SVC_PATH + "/findByCreatorLogin";
    public static final String FIND_GIFT_BY_CAPTION_GIFT_ID_PATH =
            GIFT_SVC_PATH + "/findByCaptionGiftId";
    ...
    public static final String GIFT_MARK_INAPPROPRIATE_PATH =
            GIFT_SVC_PATH + "/{id}/markInappropriate";
    public static final String GIFT_UNMARK_INAPPROPRIATE_PATH =
            GIFT_SVC_PATH + "/{id}/unmarkInappropriate";
    public static final String GIFT_IS_MARKED_INAPPROPRIATE_PATH =
            GIFT_SVC_PATH + "/{id}/isMarkedInappropriate";
    public static final String GIFT_IS_CONSIDERED_INAPPROPRIATE_PATH =
            GIFT_SVC_PATH + "/{id}/isConsideredInappropriate";
    public static final String GIFT_MARKED_INAPPROPRIATE_BY_PATH =
            GIFT_SVC_PATH + "/{id}/markedInappropriateBy";
    ...
    public OperationResult postGiftImage(@Path(ID_PARAMETER) String id,
                                         @Part(IMAGE_PARAMETER) TypedFile imageData);
    ...
    @Streaming
    @GET(GIFT_IMAGE_PATH)
    public Response getGiftImage(@Path(ID_PARAMETER) String id,
                                 @Query(IMAGE_TYPE_PARAMETER) GiftImageType type);
