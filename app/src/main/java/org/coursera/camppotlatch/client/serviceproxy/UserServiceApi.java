...
public interface UserServiceApi {
    ...
    public OperationResult postUserImage(@Path(LOGIN_PARAMETER) String login,
    ...
    @Streaming
    @GET(USER_IMAGE_PATH)
    public Response getUserImage(@Path(LOGIN_PARAMETER) String login,
                                 @Query(IMAGE_TYPE_PARAMETER) UserImageType type);

    // Password management
    @PUT(USER_PASSWORD_PATH)
    public OperationResult changePassword(@Path(LOGIN_PARAMETER) String login,
                                          @Body Collection<String> passwords);
}
